        ...
        if (!empty($username) && !empty($email) && !empty($password) && !empty($password)) {
            if ($password === $cpassword) {
                ...
                if ($con->query($sql) === TRUE) {
                    ...
                    echo "<script> alert('Details Successfully Saved.'); window.location.href = 'kkkksmi.html'; </script>";
                } else {
                ...
                echo "<script> alert('Password and confirm password do not match'); window.location.href = 'kkkkksignup.html'; </script>";
            }
        } else {
